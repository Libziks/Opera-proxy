...
Для чего этот прокси НЕ ПОДОЙДЁТ ❌
...
Клиент Telegram часто стучится на порты 8443, 5222 и использует нестандартный протокол MTProto, который ноды Opera отбрасывают как невалидный веб-трафик (работать будет, если в клиенте TG, указать адрес этого прокси т.е 192.168.1.1:1080)
Торренты (BitTorrent):
